...
# jika masih menggunakan pengaturan default, nilai ini akan
# menyebabkan front‑end melakukan panggilan jaringan langsung ke
# http://localhost:4000. Dalam produksi atau saat menggunakan proxy
# internal, hapus atau kosongkan variabel ini supaya permintaan
# tetap berada di host saat ini dan tidak menampilkan alamat
# "localhost" di konsol atau pesan error.
