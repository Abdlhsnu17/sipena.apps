...
SIPENA dibuat untuk menggantikan proses pengelolaan yang masih tersebar di catatan manual atau alur yang terpisah. Dengan sistem ini, pengelolaan aset menjadi lebih efisien, data lebih akurat, koordinasi antarpetugas lebih jelas, dan informasi operasional lebih mudah digunakan untuk evaluasi maupun pelaporan.
...
- `packages/frontend`: antarmuka pengguna Next.js.
- `packages/backend`: REST API, autentikasi, validasi, dan logika bisnis.
- `packages/db`: schema SQL, seed, dan dokumentasi database.
