...
export const NON_MEDICAL_ASSET_TYPE_LABELS: Record<NonMedicalAssetType, string> =
  Object.fromEntries(
    Object.entries(NON_MEDICAL_ASSET_TYPE_DEFINITIONS).map(([type, definition]) => [
      type,
      definition.label,
    ])
  ) as Record<NonMedicalAssetType, string>
