...
export default function SettingsPage() {
  ...
  const handleProfileSubmit = async () => {
    ...
    try {
      ...
      if (response.success && response.data?.user) {
        ...
        // 2) update localStorage supaya sidebar yang pakai getCurrentUser() ikut berubah
        try {
          const current = JSON.parse(localStorage.getItem("user") || "{}")
          const merged = { ...current, ...updated }
          localStorage.setItem("user", JSON.stringify(merged))
          // 3) trigger event agar sidebar re-render
  ...
  return (
    <div className="flex-1 overflow-auto bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 min-h-screen">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-gradient-to-br from-slate-900 to-slate-600 rounded-2xl shadow-lg">
            ...
            <div className="text-sm text-muted-foreground max-w-sm">
              <p className="text-foreground font-semibold">Konsistensi</p>
              <p>
                Semua perubahan pengaturan tercatat agar use case dan deployment tetap mengikuti diagram terbaru.
              </p>
            </div>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  <div className="w-16 h-12 rounded-lg bg-gradient-to-r from-white to-gray-900 border-2 border-gray-300 shadow-sm flex items-center justify-center">
                    <div className="flex">
