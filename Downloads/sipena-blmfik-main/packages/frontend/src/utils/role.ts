...
const staffRoutes = ["/", "/uml", "/unggahan", "/features", "/maintenance", "/reports", "/borrowing", "/returns", "/settings"]
const staffPjRoutes = [
  "/",
  "/uml",
  "/unggahan",
...
const technicianRoutes = ["/", "/uml", "/unggahan", "/features", "/maintenance", "/settings"]
