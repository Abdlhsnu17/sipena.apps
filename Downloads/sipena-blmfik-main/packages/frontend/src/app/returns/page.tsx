            ...
            <CardHeader className="space-y-3 pb-3">
              ...
              <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_220px]">
                ...
                <select
                  ...
                  className="rounded-2xl border border-border/80 bg-background px-4 py-2 text-[14px] transition focus:border-teal-500"
                >
                          ...
                          <div className="space-y-5 bg-white/80 px-6 py-6">
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                              <div className="min-w-0">
                                <p className="text-[14px] font-normal text-slate-900 dark:text-slate-100 truncate">{assetName}</p>
                                <p className="text-[13px] text-muted-foreground">{codeLabel}</p>
                                <p className="text-[13px] text-muted-foreground">No ID: {returnNoId}</p>
                                <p className="text-[13px] text-muted-foreground">
                                  Identitas: {b.userName || "-"} / {b.userNip || "-"}
                                </p>
                                <p className="text-[13px] text-muted-foreground">
                                  Unit kerja: {b.borrowerWorkUnit || "-"} • {formatBorrowingPurposeType(b.purposeType)}
                                </p>
                              </div>
                              <div className="flex flex-col gap-1 sm:items-end">
                                <span className="text-[13px] text-muted-foreground">Batas Pengembalian</span>
                                <span className="text-[14px] font-normal text-foreground">{dueDateLabel}</span>
                            ...
                            {isExpanded ? (
                              activeSections.length ? (
                                <div className="columns-1 gap-3 xl:columns-2 xl:gap-3">
                                  {activeSections.map((section) => (
                                    <div key={section.title} className="mb-3 break-inside-avoid space-y-3">
                                      <div className="rounded-2xl bg-blue-700/95 px-4 py-2 text-[14px] font-semibold text-white">
                                        {section.title}
                                      </div>
                                      <div className="divide-y divide-blue-200 rounded-2xl border border-blue-100 bg-blue-50/80">
                                        {section.lines.map((line) => (
                                          <div
                                            key={`${section.title}-${line.label}`}
                                            className="grid grid-cols-1 gap-1 px-4 py-3 text-[14px] sm:grid-cols-[160px_1fr] sm:gap-4"
                                          >
                                            <span className="text-[14px] text-blue-900">
                                              {line.label}
                                            </span>
                                            <span className="text-[14px] font-normal text-slate-900">{line.value}</span>
                                          </div>
                                        ))}
                                      </div>
                                    </div>
                              ...
                              <div className="rounded-2xl border border-blue-100 bg-blue-50/80 px-4 py-4 text-center text-[14px] text-blue-900">
                                Tekan panah untuk membuka detail pengembalian.
                              </div>
                            )}
                            <div className="flex flex-col gap-3 border-t border-blue-100 pt-4 sm:flex-row sm:items-center sm:justify-between">
                              ...
                              <div className="flex flex-wrap items-center gap-2">
                                <Button
                                  ...
                                  className="h-8 rounded-full bg-teal-600 px-4 text-[14px] font-semibold text-white hover:bg-teal-700"
                                >
                                  Kembalikan
                                </Button>
                                <DropdownMenu>
                    ...
                    <div className="lg:col-span-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full rounded-2xl border border-border/80 bg-background px-10 py-2 text-[14px] text-foreground transition focus:border-teal-500"
                        />
                      </div>
                    </div>
                    <select
                      ...
                      className="rounded-2xl border border-border/80 bg-background px-3 py-2 text-[14px] transition focus:border-teal-500"
                    >
                      <option value="Semua">Semua Sumber</option>
                      <option value="medis">Inventaris Medis</option>
                      <option value="non_medis">Inventaris Non-Medis</option>
                        ...
                        <div className="space-y-5 bg-white/80 px-6 py-6">
                          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div className="min-w-0">
                              ...
                              <p className="text-[13px] text-muted-foreground">No ID: {returnNoId}</p>
                              <p className="text-[13px] text-muted-foreground">
                                Identitas: {borrowerName} / {b.userNip || "-"}
                              </p>
                              <p className="text-[13px] text-muted-foreground">
                                Unit kerja: {b.borrowerWorkUnit || "-"} • {formatBorrowingPurposeType(b.purposeType)}
                              </p>
                            ...
                            <div className="flex flex-col gap-1 sm:items-end">
                              <span className="text-[13px] text-muted-foreground">Waktu Kembali</span>
                              <span className="text-[14px] font-normal text-foreground">{returnDateLabel}</span>
                              <div>{getStatusBadge(b.status)}</div>
                            </div>
                          </div>
                          {isExpanded ? (
                            ...
                            <div className="rounded-2xl border border-blue-100 bg-blue-50/80 px-4 py-4 text-center text-[14px] text-blue-900">
                              Tekan panah untuk membuka detail riwayat.
                            </div>
                          )}
                          <div className="flex flex-wrap items-center justify-between gap-3 pt-4 text-[14px] text-slate-600">
                                  ...
                                  {b.status === "returned" &&
                                    (b.returnValidatedAt ? (
                                      <Button
                                        variant="outline"
                                        size="sm"
                                        className="h-8 px-3 text-[13px] text-muted-foreground border-border/60"
                                        disabled
                                      >
                                        Tervalidasi
                                      </Button>
                                      ...
                                      <Button
                                        variant="outline"
                                        size="sm"
                                        className="h-8 px-3 text-[14px] text-green-700 border-green-600 hover:bg-green-50"
