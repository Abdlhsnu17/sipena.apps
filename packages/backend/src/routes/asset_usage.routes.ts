...
import assetUsageController from '../controllers/asset_usage.controller';
...
router.delete('/:id', [param('id').isInt({ min: 1 })], requireRole(['admin', 'leader']), assetUsageController.delete);
