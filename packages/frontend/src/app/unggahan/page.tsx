        ...
        <div className="flex w-full flex-col gap-6 md:gap-8">
          <section className="rounded-2xl border border-slate-200/70 bg-white/90 panel-gutter shadow-sm backdrop-blur-sm dark:border-slate-800/35 dark:bg-slate-900/60">
            <div className="flex items-start gap-3 sm:items-center sm:gap-5">
              ...
              <div className="max-w-2xl">
                ...
                <div className="flex flex-wrap gap-2 text-[11px] mt-3">
                  <Badge variant="outline" className="rounded-full border-slate-200 dark:border-slate-800/35 bg-slate-50 dark:bg-slate-900/40 px-3 py-1 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-900/40">
            ...
            <div className="panel-gutter">
              <Card className="rounded-[28px] border border-slate-200 dark:border-slate-800/35/70 bg-white/90 dark:bg-slate-900/60 shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
                <CardContent className="space-y-4 p-4 md:p-5">
                  ...
                  <div className="grid gap-3 lg:grid-cols-2">
                    <Button
                      type="button"
                      variant="outline"
                      className="flex h-auto items-center justify-between gap-3 rounded-2xl border-sky-100/80 bg-linear-to-r from-sky-50 to-cyan-50 px-3 py-3 text-left text-sm font-semibold text-sky-700 hover:border-sky-200 hover:bg-sky-50 dark:border-sky-400/20 dark:from-sky-400/10 dark:to-cyan-400/10 dark:text-sky-200 dark:hover:border-sky-400/30 dark:hover:from-sky-400/15 dark:hover:to-cyan-400/15"
                      onClick={openFilePicker}
                    >
                      <span className="truncate">
                        {uploadedReportName ? `Terpilih: ${uploadedReportName}` : "Pilih file dokumen"}
                      </span>
                      <span className="text-[11px] font-semibold uppercase tracking-[0.3em] text-sky-700 dark:text-sky-300">File</span>
                    </Button>
                    <Button
                      type="button"
                      variant="outline"
                      className="flex h-auto items-center justify-between gap-3 rounded-2xl border-cyan-100/80 bg-linear-to-r from-cyan-50 to-sky-50 px-3 py-3 text-left text-sm font-semibold text-cyan-700 hover:border-cyan-200 hover:bg-cyan-50 dark:border-cyan-400/20 dark:from-cyan-400/10 dark:to-sky-400/10 dark:text-cyan-200 dark:hover:border-cyan-400/30 dark:hover:from-cyan-400/15 dark:hover:to-sky-400/15"
                      onClick={openFolderPicker}
                    >
                      <span className="truncate">Pilih folder arsip</span>
                      <span className="text-[11px] font-semibold uppercase tracking-[0.3em] text-cyan-700 dark:text-cyan-300">Folder</span>
                    </Button>
                  </div>
            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                {uploadedReports.map((report) => (
                  <article
                    key={report.id}
                    className="space-y-3 rounded-3xl border border-slate-200/70 bg-white/80 p-4 shadow-sm dark:border-slate-800/35 dark:bg-slate-900/50"
                  >
