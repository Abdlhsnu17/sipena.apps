          ...
          {step === "request" ? (
            ...
            <form onSubmit={handleResetPassword} className="space-y-3">
              ...
              {deliveryMethod === "local_preview" && (
                <div className="rounded-lg border border-cyan-200 bg-cyan-50 px-3 py-3 text-sm text-cyan-800 dark:border-cyan-400/30 dark:bg-cyan-400/10 dark:text-cyan-300">
                  Kode reset preview:{" "}
