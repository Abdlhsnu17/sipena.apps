...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      <Card
        className="relative z-10 w-full max-w-md max-h-[calc(100svh-2rem)] overflow-y-auto border border-white/20 bg-white/95 shadow-2xl backdrop-blur-lg dark:border-slate-800/35 dark:bg-slate-900/90"
        data-auth-card
      >
        <CardContent className="space-y-4 pt-5 sm:pt-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              ...
              <div className="relative">
                <User2 className="absolute left-3 top-3 h-5 w-5 text-teal-600 dark:text-teal-400" />
                <Input
                  id="name"
                  type="text"
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-3 h-5 w-5 text-teal-600 dark:text-teal-400" />
                <Input
                  id="email"
                  type="email"
            ...
            <div>
              ...
              <div className="relative">
                <Smartphone className="absolute left-3 top-3 h-5 w-5 text-teal-600 dark:text-teal-400" />
                <Input
                  id="phoneNumber"
                  type="tel"
            ...
            {message && (
              <div
                className={`flex items-start gap-2 rounded-lg border px-3 py-3 text-sm ${
                  messageType === "success"
                    ? "border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-400/30 dark:bg-emerald-400/10 dark:text-emerald-400"
                    : "border-red-200 bg-red-50 text-red-700 dark:border-red-400/30 dark:bg-red-400/10 dark:text-red-400"
                }`}
              >
                {messageType === "success" ? (
