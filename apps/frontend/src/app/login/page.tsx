    ...
    >
      ...
      <div className="relative z-10 flex w-full justify-center px-2 sm:px-4">
        <div className="w-full max-w-md" data-auth-card>
          <div className="max-h-[calc(100svh-2rem)] overflow-y-auto rounded-3xl border border-white/20 bg-white/95 p-5 shadow-2xl backdrop-blur-lg sm:p-6 dark:border-slate-800/35 dark:bg-slate-900/90">
            <AuthHeader
              title="SiPeNa"
              description="Sistem Inventaris Peminjaman serta Pemeliharaan Sarana"
              variant="inline"
            />
            ...
            <form onSubmit={handleSubmit} className="mt-2 space-y-3">
              <div>
                ...
                <div className="relative">
                  <IdCard className="absolute left-3 top-3 h-5 w-5 text-teal-600 dark:text-teal-400" />
                  <Input
                    id="nip"
                    type="text"
                    ...
                    className="border-gray-200 pl-10 transition-colors focus:border-teal-500 focus:ring-teal-500 dark:border-slate-700"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-5 w-5 text-teal-600 dark:text-teal-400" />
                  <Input
                    id="password"
                    ...
                    className="border-gray-200 pl-10 pr-10 transition-colors focus:border-teal-500 focus:ring-teal-500 dark:border-slate-700"
                  />
                  <button
                    type="button"
              ...
              <div className="text-right">
                <button
                  ...
                  disabled={isLoading}
                  className="ml-auto flex items-center gap-1 text-sm font-medium text-teal-600 transition-colors hover:text-teal-700 hover:underline disabled:opacity-50 disabled:hover:text-teal-600 dark:text-teal-400 dark:hover:text-teal-300 dark:disabled:hover:text-teal-400"
                >
              ...
              {error && (
                <div className="flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-600 dark:border-red-400/30 dark:bg-red-400/10 dark:text-red-400">
              ...
              <div className="border-t border-gray-100 pt-3 text-center dark:border-slate-800/35">
