...
export const canViewAllActivitiesRole = (role?: string | null): boolean => {
  const normalized = normalizeUserRole(role)
...
const staffRoutes = ["/", "/uml", "/unggahan", "/maintenance", "/maintenance-schedule", "/dss", "/asset-usage", "/reports", "/activity-archive", "/borrowing", "/returns", "/settings"]
const staffPjRoutes = [
  "/",
  "/uml",
  "/unggahan",
...
const technicianRoutes = ["/", "/uml", "/unggahan", "/maintenance", "/maintenance-schedule", "/dss", "/reports", "/activity-archive", "/settings"]
...
export const canManageDisposalRole = (role?: string | null): boolean => {
  return isAdminOrLeaderRole(role)
}

export const canManageSanctionsRole = (role?: string | null): boolean => {
  return isAdminOrLeaderRole(role)
}
