...
import { CreateMaintenanceHistoryDTO, MaintenanceHistory } from '../models/maintenance-history.model';
...
const SELECT_WITH_USERS = `
  SELECT
    ...
    creator.work_unit AS requester_work_unit,
    creator.sub_work_unit AS requester_sub_work_unit,
