...
router.post(
  ...
  [
    ...
    body('dueAt').optional().isISO8601().withMessage(isoDateTimeMessage('Batas waktu')),
    body('startedAt').optional().isISO8601().withMessage(isoDateTimeMessage('Waktu mulai')),
    body('completedDate').optional().isISO8601().withMessage(isoDateTimeMessage('Tanggal selesai')),
    body('actualStartAt').optional().isISO8601().withMessage(isoDateTimeMessage('Waktu mulai aktual')),
    body('actualEndAt').optional().isISO8601().withMessage(isoDateTimeMessage('Waktu selesai aktual')),
    body('vendorName').optional().trim(),
    body('vendorReference').optional().trim(),
    body('warrantyUntil').optional().isISO8601().withMessage(isoDateTimeMessage('Batas garansi')),
    ...
    body('nextMaintenanceDate').optional().isISO8601().withMessage(isoDateTimeMessage('Tanggal maintenance berikutnya')),
...
router.put(
  ...
  [
    ...
    body('priority').optional().isIn(MAINTENANCE_PRIORITIES),
    body('scheduledDate').optional().isISO8601().withMessage(isoDateTimeMessage('Tanggal terjadwal')),
    body('description').optional().trim(),
    body('technician').optional().trim(),
    body('technicianUserId').optional().isInt({ min: 1 }).toInt(),
    body('dueAt').optional().isISO8601().withMessage(isoDateTimeMessage('Batas waktu')),
